...
public class ViewPropertyAnimatorCompat
{
  ...
  public long getDuration()
  {
    View localView = (View)this.mView.get();
    if (localView != null);
    for (long l = IMPL.getDuration(localView); ; l = 0L)
      return l;
  }
  ...
  public Interpolator getInterpolator()
  {
    View localView = (View)this.mView.get();
    if (localView != null);
    for (Interpolator localInterpolator = IMPL.getInterpolator(localView); ; localInterpolator = null)
  ...
  public long getStartDelay()
  {
    View localView = (View)this.mView.get();
    if (localView != null);
    for (long l = IMPL.getStartDelay(localView); ; l = 0L)
      return l;
  }
