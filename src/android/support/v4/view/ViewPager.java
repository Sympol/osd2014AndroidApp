...
public class ViewPager extends ViewGroup
{
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      label397: for (float f5 = this.mInitialMotionX + this.mTouchSlop; ; f5 = this.mInitialMotionX - this.mTouchSlop)
      {
  ...
  void populate(int paramInt)
  {
    ...
    label384: label398: label674: label686: 
    while (true)
    {
      return;
      i = 17;
      ...
      else if (getWindowToken() != null)
      {
        ...
        for (Object localObject2 = ((ItemInfo)localObject1).object; ; localObject2 = null)
        {
          ...
          break label398;
          label708: int i22 = localItemInfo5.position;
