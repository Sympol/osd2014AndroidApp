...
public class SlidingPaneLayout extends ViewGroup
{
  ...
  private void onPanelDragged(int paramInt)
  {
    ...
    label147: label156: for (int m = localLayoutParams.rightMargin; ; m = localLayoutParams.leftMargin)
    {
          ...
          if ((this.mDragHelper.shouldInterceptTouchEvent(paramMotionEvent)) || (j != 0))
          {
            ...
            if (bool4)
            {
              ...
              if (bool5)
              {
                ...
                boolean bool2 = f3 < this.mDragHelper.getTouchSlop();
                j = 0;
                if (bool2)
                {
                  boolean bool3 = f4 < f3;
  ...
  boolean smoothSlideTo(float paramFloat, int paramInt)
  {
    ...
    if (!bool1)
      return bool2;
    boolean bool3 = isLayoutRtlSupport();
    LayoutParams localLayoutParams = (LayoutParams)this.mSlideableView.getLayoutParams();
    int j;
    int k;
    if (bool3)
    ...
    {
      boolean bool4 = this.mDragHelper.smoothSlideViewTo(this.mSlideableView, i, this.mSlideableView.getTop());
      bool2 = false;
      if (!bool4)
        break;
  ...
  private class DragHelperCallback extends ViewDragHelper.Callback
  {
    ...
    public void onViewDragStateChanged(int paramInt)
    {
      ...
      {
        return;
        label63: SlidingPaneLayout.this.dispatchOnPanelOpened(SlidingPaneLayout.this.mSlideableView);
