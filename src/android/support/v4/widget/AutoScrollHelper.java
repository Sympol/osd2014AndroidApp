  ...
  implements View.OnTouchListener
{
  ...
  private float computeTargetVelocity(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    while (true)
    {
      ...
      if (f1 > 0.0F)
        f2 = constrain(f1 * f6, f4, f5);
      else
        f2 = -constrain(f6 * -f1, f4, f5);
    }
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
    default:
      label52: if ((!this.mExclusive) || (!this.mAnimating))
        break;
    case 0:
    case 2:
    case 1:
  ...
  private static class ClampedScroller
  {
    ...
    {
      boolean bool = paramLong < this.mStartTime;
      float f = 0.0F;
      if (bool);
      while (true)
      {
