...
public class TransportMediator extends TransportController
{
  ...
  private TransportMediator(Activity paramActivity, View paramView, TransportPerformer paramTransportPerformer)
  {
    ...
    label146: for (this.mController = new TransportMediatorJellybeanMR2(this.mContext, this.mAudioManager, this.mView, this.mTransportKeyCallback); ; this.mController = null)
    {
      return;
