...
class ActionBarImplICS extends ActionBar
{
  ...
  private OnMenuVisibilityListenerWrapper findAndRemoveMenuVisWrapper(ActionBar.OnMenuVisibilityListener paramOnMenuVisibilityListener)
  {
    ...
    while (true)
    {
      ...
      localOnMenuVisibilityListenerWrapper = null;
    }
  }
  ...
  ImageView getHomeActionView()
  {
    ...
    label100: for (View localView4 = localView3; ; localView4 = localView2)
    {
      if ((localView4 instanceof ImageView))
        this.mHomeActionView = ((ImageView)localView4);
      localImageView = this.mHomeActionView;
      break;
    }
  }
  ...
  public void setHomeAsUpIndicator(int paramInt)
  {
    ...
    {
      return;
      label19: localImageView.setImageDrawable(getThemeDefaultUpIndicator());
    }
  }
