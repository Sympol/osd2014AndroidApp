  ...
  implements MenuPresenter.Callback, MenuBuilder.Callback
{
  ...
  private void applyFixedSizeWindow()
  {
    ...
    label206: label238: TypedValue localTypedValue6;
    if (localDisplayMetrics.widthPixels < localDisplayMetrics.heightPixels)
    {
      ...
      label247: if ((localTypedValue6 != null) && (localTypedValue6.type != 0))
      {
    ...
    while (true)
    {
      ...
      i = 0;
      break;
      label316: localTypedValue5 = localTypedValue1;
      break label206;
      label322: if (localTypedValue5.type != 6)
        break label238;
      j = (int)localTypedValue5.getFraction(localDisplayMetrics.widthPixels, localDisplayMetrics.widthPixels);
      break label238;
      label355: localTypedValue6 = localTypedValue4;
      break label247;
      label362: if (localTypedValue6.type == 6)
  ...
  private MenuView getListMenuView(Context paramContext, MenuPresenter.Callback paramCallback)
  {
    ...
    while (true)
    {
      localMenuView = this.mListMenuPresenter.getMenuView(new FrameLayout(paramContext));
      break;
  ...
  final void ensureSubDecor()
  {
    ...
    if (!this.mSubDecorInstalled)
    {
      ...
      label117: ActionBarContainer localActionBarContainer = (ActionBarContainer)this.mActivity.findViewById(R.id.split_action_bar);
    ...
    while (true)
    {
      ...
      return;
      label283: this.mActivity.superSetContentView(R.layout.abc_action_bar_decor);
      break;
      label296: TypedArray localTypedArray = this.mActivity.obtainStyledAttributes(R.styleable.ActionBarWindow);
      bool2 = localTypedArray.getBoolean(2, false);
      localTypedArray.recycle();
      break label117;
      label322: this.mActivity.superSetContentView(R.layout.abc_simple_decor);
    }
  }
