  ...
  implements SupportMenu
{
  ...
  public boolean collapseItemActionView(MenuItemImpl paramMenuItemImpl)
  {
    ...
    while (true)
    {
      ...
      while (!bool);
      label98: startDispatchingItemsChanged();
      if (bool)
  ...
  public boolean expandItemActionView(MenuItemImpl paramMenuItemImpl)
  {
    ...
    while (true)
    {
      ...
      while (!bool);
      label90: startDispatchingItemsChanged();
      if (bool)
  ...
  MenuItemImpl findItemWithShortcutForKey(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    label195: for (int k = 0; ; k++)
    {
      ...
      {
        if (((m != localKeyData.meta[0]) || ((i & 0x2) != 0)) && ((m != localKeyData.meta[2]) || ((i & 0x2) == 0)) && ((!bool2) || (m != 8) || (paramInt != 67)))
          break label195;
  ...
  public boolean performItemAction(MenuItem paramMenuItem, int paramInt)
  {
    ...
    while (true)
    {
      ...
      label85: if ((localMenuItemImpl.hasSubMenu()) || (i != 0))
      {
        close(false);
        if (!localMenuItemImpl.hasSubMenu())
