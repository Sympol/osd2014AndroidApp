  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    if (i == 1073741824)
    {
      i1 = View.MeasureSpec.makeMeasureSpec(k - n, 1073741824);
      i2 = j - m;
    ...
    {
      return;
      i1 = View.MeasureSpec.makeMeasureSpec(Math.min(this.mMaxItemHeight, k - n), -2147483648);
      break;
      label117: int i5 = this.mMinCellSize + i4 / i3;
      int i6 = i3;
      int i7 = 0;
      int i8 = 0;
      int i9 = 0;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (true)
    {
      ...
      int m = 0;
      n = 0;
      i1 = paramInt3 - paramInt1 - getPaddingRight() - getPaddingLeft();
      i2 = 0;
      int i3 = 0;
      if (i3 < i)
      {
    ...
    while (true)
    {
      ...
      label438: i6 = 0;
      break label366;
      label444: int i10 = i8 + localLayoutParams1.leftMargin;
